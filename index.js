...
const h8 = document.getElementById("8");
const h9 = document.getElementById("9");
const h10 = document.getElementById("10");
const h11 = document.getElementById("11");

const d1h8 = document.getElementById("d1h8");
const d2h8 = document.getElementById("d2h8");
const d3h8 = document.getElementById("d3h8");
const d4h8 = document.getElementById("d4h8");
const d5h8 = document.getElementById("d5h8");

const d1h9 = document.getElementById("d1h9");
const d2h9 = document.getElementById("d2h9");
const d3h9 = document.getElementById("d3h9");
const d4h9 = document.getElementById("d4h9");
const d5h9 = document.getElementById("d5h9");

const d1h10 = document.getElementById("d1h10");
const d2h10 = document.getElementById("d2h10");
const d3h10 = document.getElementById("d3h10");
const d4h10 = document.getElementById("d4h10");
const d5h10 = document.getElementById("d5h10");

const d1h11 = document.getElementById("d1h11");
const d2h11 = document.getElementById("d2h11");
const d3h11 = document.getElementById("d3h11");
const d4h11 = document.getElementById("d4h11");
const d5h11 = document.getElementById("d5h11");
...
function updateTime() {
    ...
    // Get JS day (0=Sunday, 1=Monday, ..., 6=Saturday)
    let dayOfWeek = date.getDay();
    // Convert so Monday=1, ..., Friday=5 (skip weekends)
    if (dayOfWeek === 0) dayOfWeek = 7; // Sunday -> 7

    hourOfTheDay.textContent = `${currentHour}:${formattedMinutes}`;

    // Reset previous highlights
    const allHourElements = [h8, h9, h10, h11];
    ...
    if (currentHour >= 8 && currentHour <= 11) {
        ...
        // Highlight current cell if applicable (Monday=1, ..., Friday=5)
    ...
    [monday, tuesday, wednesday, thursday, friday].forEach((el, idx) => {
        if (el) el.classList.toggle("current-day", dayOfWeek === idx + 1);
    });
}
